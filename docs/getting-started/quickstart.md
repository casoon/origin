---
title: Quickstart
description: "Run the reference application, try what it demonstrates, and read the code that assembles it."
order: 2
---
...
On Linux, install the Tauri system dependencies listed in the [README](https://github.com/casoon/origin/blob/main/README.md).
...
1. [`examples/demo/src-tauri/src/lib.rs`](https://github.com/casoon/origin/blob/main/examples/demo/src-tauri/src/lib.rs) —
   the composition root. Every dependency the product has is in one function.
2. [`examples/demo/src-tauri/src/pulse.rs`](https://github.com/casoon/origin/blob/main/examples/demo/src-tauri/src/pulse.rs) —
