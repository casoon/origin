...
description: "Scaffold a product with cargo xtask new and keep it current with tested migrations."
order: 1
---

Decisions: [ADR-0025](https://github.com/casoon/origin/blob/main/adr/0025-project-migrations.md),
[ADR-0026](https://github.com/casoon/origin/blob/main/adr/0026-downstream-verification.md).
