---
title: Security
description: "Two permission levels, capabilities scoped per window, credentials in the OS credential store, and what the opener refuses."
order: 3
---

See [ADR-0007](https://github.com/casoon/origin/blob/main/adr/0007-security-and-capability-model.md) for the decision.
