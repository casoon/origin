---
title: Architecture in the code
description: "How the binding rules play out: Tauri as host, the composition root, modules, events, the frontend boundary and the platform contracts."
order: 2
---

The rules are in [ARCHITECTURE.md](https://github.com/casoon/origin/blob/main/ARCHITECTURE.md). This page explains how they
