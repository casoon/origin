...
description: "Add a feature area: service, registration, settings, events, commands and a test that needs no Tauri."
order: 1
---

A module is a feature area: Inbox, Projects, Traffic, Health. Use
[`examples/demo/src-tauri/src/pulse.rs`](https://github.com/casoon/origin/blob/main/examples/demo/src-tauri/src/pulse.rs) as the
worked example.
...
Read [ADR-0009](https://github.com/casoon/origin/blob/main/adr/0009-module-promotion-rule.md). A feature stays in the product
