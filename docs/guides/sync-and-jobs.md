---
title: Sync and jobs
description: "The sync engine owns scheduling, backoff and offline handling; jobs cover one-off work with progress and cancellation."
order: 3
---

Decisions: [ADR-0017](https://github.com/casoon/origin/blob/main/adr/0017-sync-engine-owns-scheduling.md),
[ADR-0018](https://github.com/casoon/origin/blob/main/adr/0018-backoff-jitter-and-offline.md),
[ADR-0019](https://github.com/casoon/origin/blob/main/adr/0019-storage-namespace-convention.md),
[ADR-0020](https://github.com/casoon/origin/blob/main/adr/0020-jobs-are-process-local.md).
...
[`Health`](https://github.com/casoon/origin/blob/main/crates/origin-domain/src/health.rs) model. It is not a method on `SyncState`
