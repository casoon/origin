---
title: Authentication and connectors
description: "OAuth with PKCE over a loopback redirect, token refresh, several accounts per connector, HTTP and rate limits."
order: 2
---

Decisions: [ADR-0006](https://github.com/casoon/origin/blob/main/adr/0006-connector-architecture.md),
[ADR-0014](https://github.com/casoon/origin/blob/main/adr/0014-http-as-a-port.md),
[ADR-0015](https://github.com/casoon/origin/blob/main/adr/0015-oauth-redirect-via-loopback.md),
[ADR-0016](https://github.com/casoon/origin/blob/main/adr/0016-multi-account-from-day-one.md).
